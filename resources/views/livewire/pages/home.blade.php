<div class="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gray-50 py-6 sm:py-12">
    ...
    <div class="relative bg-white px-6 py-6 shadow-xl ring-1 ring-gray-900/5 mx-auto w-fit sm:rounded-lg sm:px-6">
            ...
            <div class="divide-y divide-gray-300/50">
                ...
                <div class="space-y-6 py-3 text-base leading-7 text-gray-600">
                    ...
                    <form wire:submit="check" id="form">
                        ...
                        <x-filament::button wire:click="create" color="primary" class="mt-6 w-full font-bold">
                            Send Now
                        </x-filament::button>
                    </form>
